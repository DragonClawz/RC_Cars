...
const int headlight_r = 12;
const int headlight_l = 13;
...
void setup()
{
  ...
  BT.begin(9600);
  Serial.begin(9600);
  pinMode(6, OUTPUT); // connect to input 1 of l293d
  pinMode(5, OUTPUT); // connect to input 4 of l293d
  pinMode(4, OUTPUT); // connect to input 3 of l293d
     ...
     if( currentstate == HIGH ) // If input only changes from LOW to HIGH
       {
         ...
         speedy = (3.14*(0.9)*(rpm/60)); // speed in m/s
